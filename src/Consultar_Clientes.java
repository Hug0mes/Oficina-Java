...
public class Consultar_Clientes extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Consultar_Clientes frame = new Consultar_Clientes();
	...
	public Consultar_Clientes() {
		addWindowListener(new WindowAdapter() {
			...
			public void windowOpened(WindowEvent e) {
				...
				try {            		
		            ...
		            String sql="Select IdCliente, Nome, Telefone, NIF, Email from cliente";
		...
		JLabel lblNewLabel_3 = new JLabel("Consultar Clientes");
		lblNewLabel_3.setForeground(new Color(204, 204, 204));
		lblNewLabel_3.setFont(new Font("Tahoma", Font.BOLD, 16));
		lblNewLabel_3.setBounds(259, 102, 162, 35);
