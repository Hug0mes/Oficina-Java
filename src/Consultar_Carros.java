...
public class Consultar_Carros extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Consultar_Carros frame = new Consultar_Carros();
	...
	public Consultar_Carros() {
		...
		JLabel lblNewLabel_3 = new JLabel("Consultar Carros");
		lblNewLabel_3.setForeground(new Color(204, 204, 204));
		lblNewLabel_3.setFont(new Font("Tahoma", Font.BOLD, 16));
		lblNewLabel_3.setBounds(260, 103, 161, 35);
		contentPane.add(lblNewLabel_3);
		
		JScrollPane scrollPane_1 = new JScrollPane();
		scrollPane_1.setBounds(10, 149, 643, 273);
